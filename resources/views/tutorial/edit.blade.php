    ...
    <form id="create-tutorial-form" class="create-tutorial" action="{{ route('dashboard.tutorial.update', $tutorial) }}" method="post">
        <div class="container mb-5">
            ...
            <div class="create-tutorial-form-container container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div
                            ...
                            style="background-image: @if(old("main_image"))  url('{{ presentImage(old("main_image")) }}') @else url('{{ presentImage($tutorial->main_image) }}')  @endif;border : 1px solid #acacac"
                        >
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                      ...
                                      required>{{ old("description") ? old("description") : $tutorial->description }}</textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="duration" type="number" name="duration"
                                               value="{{ old("duration")  ? old("duration") : $tutorial->duration}}"
                                               required>
                                        <div class="input-group-append">
                                            <select class="form-control" id="duration_measurement"
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        <select class="form-control js-example-tokenizer select2-hidden-accessible"
                                                ...
                                                data-select2-id="select2-data-10-wfcs" tabindex="-1" aria-hidden="true"
                                                style="width: 100%">
                                        </select>
                                    </p>
                                </div>
                ...
                <hr class="custom-doted-hr">
                <div class="form-group">
                    <label for="introduction" style="font-size: 27px">مقدمة <span class="text-muted"
                                                                                  style="font-size: 15px !important;">(اختياري)</span></label>
                    <textarea class="form-control introduction" id="introduction" name="introduction" dir="rtl">
                        {{ old("introduction") ? old("introduction") :  $tutorial->introduction }}
                    </textarea>
                </div>

                <div class="form-group">
                    <label for="introduction_video" style="font-size: 27px">فيديو (يوتيوب) للمقدمة <span
                            class="text-muted" style="font-size: 15px !important;">(اختياري)</span></label>
                    <input type="text" id="introduction_video" name="introduction_video" class="form-control"
                           placeholder="أدخل عنوان URL لفيديو يوتيوب"
                           value="{{ old("introduction_video") ? old("introduction_video") :  "https://youtu.be/".$tutorial->introduction_video }}">
                </div>
                        ...
                        @foreach($tutorial->steps  as $step)
                            <div class="single-step row rounded-lg justify-content-between bg-white px-2 pb-3 my-4">
                                ...
                                <div class="col-lg-5 p-0 pt-3 left-single-step">
                                    <div id="step-{{ $step->order }}-images-container" class="step-images-container"
                                         data-steporder="">

                                        @if(isset($step->images))
                                            @foreach($step->images as $key => $val)
                                                <input type="hidden"
                                                       name="steps[{{ $step->order }}][step_images][{{ $key }}]" id=""
                                                       value="{{ $val }}">
                                            @endforeach
                                        @endif
                                    </div>
                                ...
                                <div class="col-lg-6 p-0 pt-3">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="" placeholder="عنوان الخطوة"
                                                   class="form-control step-title" value="{{ $step->title }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control step-content" name=""
                                                  dir="rtl">{{ $step->content }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach

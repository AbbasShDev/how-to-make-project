...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <img class="c-sidebar-brand-full" style="width: 100px !important;" src="{{ asset("images/logo-white.png") }}" alt="logo">
        <img class="c-sidebar-brand-minimized" style="width: 70px !important;" src="{{ asset("images/logo-white.png") }}" alt="logo">
    </div>
...
<div class="c-wrapper c-fixed-components">
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <a class="c-header-brand d-lg-none" href="#">
            <img style="width: 100px !important;" src="{{ asset("images/logo-black.png") }}" alt="logo">
        </a>
        ...
        <ul class="c-header-nav mr-auto ml-4">
            <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right py-0 my-0 my-md-1">
